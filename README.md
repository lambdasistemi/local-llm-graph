...
- **46 nodes** across 8 categories: models, engines, formats, proxies, assistants, hardware, hubs, protocols
- **62 edges** showing compatibility, translation, and dependency relationships
